...
export default function OrcamentoLine1({nome, data, obs, id, telefone, email}) {
        ...
        <Card sx={{maxWidth: 280, margin: 2}}>
            <CardHeader
                ...
                subheader={<Row>
                    ...
                    <Col xs="2"><Link href={route('consultor.clientes.show', id)}><ArrowCircleUpIcon className="ml-3 mt-4"></ArrowCircleUpIcon></Link></Col>
                </Row>}
            />
