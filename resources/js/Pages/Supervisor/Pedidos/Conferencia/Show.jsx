...
// Modal -fim
    ...
    function submit(e) {
        e.preventDefault()
        put(route('supervisor.pedidos.conferencia.show', pedido.id))
    }

    return (
        <Layout titlePage="Pedidos" button={true} url={route('supervisor.pedidos.pedido.index')} textButton={'Voltar'}>
