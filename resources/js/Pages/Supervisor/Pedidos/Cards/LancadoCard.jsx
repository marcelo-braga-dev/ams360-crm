        ...
        <Card sx={{margin: 1}}>
                ...
                action={
                    <div>
                        ...
                        >
                            ...
                            <Link href={route('supervisor.pedidos.conferencia.show', dados.id)} underline="none" color="inherit">
                                <MenuItem key={dados.id} onClick={handleClose}>
                                    Reprovar Pedido
                                </MenuItem>
                            </Link>
                            <Link href={route('supervisor.pedidos.cancelado.show', dados.id)} underline="none" color="inherit">
                                <MenuItem key={dados.id} onClick={handleClose}>
                                    Cancelar Pedido
                                </MenuItem>
                            </Link>
            ...
            <Row className={"mx-0"}>
                ...
                <Col md="3" className="mt-1">
                    <Link href={route('supervisor.pedidos.lancado.show', dados.id)}>
