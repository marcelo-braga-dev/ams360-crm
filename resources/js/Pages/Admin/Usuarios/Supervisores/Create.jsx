...
export default function Register() {
    ...
    return (<Layout titlePage="Cadastrar Supervisor" button={true} url={route('admin.usuarios.usuario.index')}
                    textButton={'Voltar'}>
        ...
        <Container fluid="lg" className="bg-white px-lg-6 py-lg-5 rounded">
            ...
            <form onSubmit={submit}>
                <Typography component="h5">Cadastro de Supervisor</Typography>
